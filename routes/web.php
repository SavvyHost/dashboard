...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/rooms/my/bookings', [BookingController::class, 'my_booking'])->name('book.mine.show');
    Route::get('/rooms/my/bookings/invoice/{id}', [BookingController::class, 'my_invoice'])->name('book.invoice.show');
    Route::get('/rooms/back/bookings', [BookingController::class, 'back_booking'])->name('book.back.show');
    ...
    Route::post('/booking/{id}/reject', [BookingController::class, 'reject_booking'])->name('booking.reject.store');
    Route::post('/booking/{id}/cancel', [BookingController::class, 'cancel_booking'])->name('booking.cancel');
    ...
    Route::group(['middleware' => ['role:1']], function () {
        ...
        Route::get('/hotel/policy/{hotel_id}/new', [HousePolicyController::class, 'add'])->name('hotel.policy.form.show');
