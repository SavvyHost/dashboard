...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::group(['middleware' => ['role:1']], function() {
        ...
        // Route::get('/hotels/availabilty', [AvailabiltyController::class,'index1'])->name('hotels.availabilty.show1');
        Route::get('/hotels/availabilty/new', [AvailabiltyController::class,'index_hotel'])->name('hotels.availabilty.show.hotel');
