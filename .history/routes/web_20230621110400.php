...
///Room meals///
Route::get('/roomss/meals/new', [RoomTypeController::class,'add'])->name('hotel.room.type.form.show');
Route::post('/roomss/meals/new', [RoomTypeController::class,'save'])->name('hotel.room.type.form.save');
Route::get('/rooms/meals', [RoomTypeController::class,'index'])->name('hotel.room.type.show');
Route::get('/rooms/meals/edit/{attr}', [RoomTypeController::class,'show'])->name('hotel.room.edit.type.show');
Route::post('/rooms/meals/edit/{attr}', [RoomTypeController::class,'save_edit'])->name('hotel.room.edit.type.save');
Route::delete('/rooms/meals/{attr_id}/delete', [RoomTypeController::class,'destroy'])->name('hotel.room.type.destroy');
