...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::group(['middleware' => ['role:1']], function() {
        ...
        Route::get('/hotels/attributes', [AttributesController::class,'index'])->name('hotel.form.attr.show');
        Route::get('/hotels/attributes', [AttributesController::class,'index'])->name('hotel.form.attr.save');
        Route::get('/hotels/attributes/edit/{attr}', [AttributesController::class,'show'])->name('hotel.edit.attr.show');
        Route::post('/hotels/attributes/edit/{attr}', [AttributesController::class,'index'])->name('hotel.edit.attr.save');
