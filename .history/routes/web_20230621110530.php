...
Route::post('/roomss/meals/new', [MealController::class,'save'])->name('hotel.room.meal.form.save');
Route::get('/rooms/meals', [MealController::class,'index'])->name('hotel.room.meal.show');
Route::get('/rooms/meals/edit/{attr}', [MealController::class,'show'])->name('hotel.room.edit.meal.show');
Route::post('/rooms/meals/edit/{attr}', [MealController::class,'save_edit'])->name('hotel.room.edit.meal.save');
