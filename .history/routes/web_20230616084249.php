...
///Hotel avl///
        ...
        Route::get('/rooms/new/{hotel_id}/news', [AddRoomController::class,'indexmore'])->name('room.att.form.show');

        Route::get('/rooms/{hotel_id}/new', [AddRoomController::class,'index'])->name('room.form.show');
...
///Room Type///
Route::get('/hotels/attributes/new', [RoomTypeController::class,'add'])->name('hotel.room.type.form.show');
Route::post('/hotels/attributes/new', [RoomTypeController::class,'save'])->name('hotel.room.type.form.save');
Route::get('/hotels/attributes', [RoomTypeController::class,'index'])->name('hotel.room.type.show');
Route::get('/hotels/attributes/edit/{attr}', [RoomTypeController::class,'show'])->name('hotel.room.edit.type.show');
Route::post('/hotels/attributes/edit/{attr}', [RoomTypeController::class,'save_edit'])->name('hotel.room.edit.type.save');
Route::delete('/hotels/attribute/{attr_id}/delete', [RoomTypeController::class,'destroy'])->name('hotel.room.type.destroy');
...
//
//
        Route::get('/rooms/attributes/new', [RoomAttributesController::class,'add'])->name('hotel.room.attr.form.show');
        Route::post('/rooms/attributes/new', [RoomAttributesController::class,'save'])->name('hotel.room.attr.form.save');
        Route::get('/rooms/attributes', [RoomAttributesController::class,'index'])->name('room.attr.show');
        // Route::get('/rooms/attributes/edit/{attr}', [RoomAttributesController::class,'show'])->name('hotel.edit.room.attr.show');
        // Route::post('/rooms/attributes/edit/{attr}', [RoomAttributesController::class,'save_edit'])->name('hotel.room.edit.attr.save');
        // // Route::delete('/hotels/attribute/{attr_id}/term/delete', [AttributesController::class,'destroy'])->name('hotel.attr.destroy');
