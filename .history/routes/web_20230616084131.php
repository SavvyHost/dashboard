...
///Room Type///
Route::get('/hotels/attributes/new', [RoomTypeController::class,'add'])->name('hotel.attr.form.show');
Route::post('/hotels/attributes/new', [RoomTypeController::class,'save'])->name('hotel.attr.form.save');
Route::get('/hotels/attributes', [RoomTypeController::class,'index'])->name('hotel.attr.show');
Route::get('/hotels/attributes/edit/{attr}', [RoomTypeController::class,'show'])->name('hotel.edit.attr.show');
Route::post('/hotels/attributes/edit/{attr}', [RoomTypeController::class,'save_edit'])->name('hotel.edit.attr.save');
Route::delete('/hotels/attribute/{attr_id}/delete', [RoomTypeController::class,'destroy'])->name('hotel.attr.destroy');
