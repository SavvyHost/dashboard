...
///Hotel Policy///
        ...
        Route::get('/hotels/{hotel_id}/edit', [HousePolicyController::class,'show'])->name('hotel.edit.form.show');
        Route::post('/hotels/{hotel_id}/edit', [HousePolicyController::class,'save'])->name('hotel.edit.form.save');
