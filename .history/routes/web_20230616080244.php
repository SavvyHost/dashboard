...
///Hotel avl///
        ...
        Route::get('/rooms/{hotel_id}/edit', [EditRoomController::class,'show'])->name('hotel.edit.form.show');
        Route::post('/room/{hotel_id}/edit', [EditRoomController::class,'save'])->name('hotel.edit.form.save');
