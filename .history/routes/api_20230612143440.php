...
Route::group(['middleware' , 'prefix' => 'dashboard'], function () {
    ...
    Route::post('/tours/new', [AddTourController::class, 'save']);
    Route::put('/tours/{tour_id}', [EditTourController::class, 'save']);
    Route::delete('/tours/delete/{tour_id}', [TourController::class, 'delete']);




    ///Tour Category///
    Route::get('/tours/category', [TourCategoryController::class, 'index']);
    Route::post('/tours/category/new', [TourCategoryController::class, 'save_new']);
    Route::put('/tours/category/{category_id}', [TourCategoryController::class, 'save_edit']);
    Route::delete('/tours/category/delete/{category_id}', [TourCategoryController::class, 'delete']);


    ///Tour Attributes///
    Route::get('/tours/attributes', [TourAttrController::class, 'show']);
    Route::post('/tours/attributes/new', [TourAttrController::class, 'save']);
    Route::put('/tours/attributes/{attributes_id}', [TourAttrController::class, 'update']);
    Route::delete('/tours/attributes/delete/{attributes_id}', [TourAttrController::class, 'delete']);
        ...
        ///Tour Terms///
        Route::get('/hotels/terms', [TourTermController::class, 'index']);
        Route::get('/hotels/attributes/{attr_id}/terms', [TourTermController::class, 'show']);
        Route::get('/hotels/{hotel_id}/terms', [TourTermController::class, 'exceptions']);
        Route::post('/hotels/attributes/terms/new', [TourTermController::class, 'save']);
        Route::put('/hotels/attributes/terms/{attr_id}', [TourTermController::class, 'update']);
        Route::delete('hotels/attributes/terms/delete/{terms_id}', [TourTermController::class, 'delete']);
