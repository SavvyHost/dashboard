...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::group(['middleware' => ['role:1']], function() {
        ...
        Route::post('/subscribers/{user_id}', [SubscribersController::class,'index'])->name('subscribers.update.form.show');
        Route::post('/subscribers/{user_id}/edit', [SubscribersController::class,'update'])->name('subscribers.update.form.save');
