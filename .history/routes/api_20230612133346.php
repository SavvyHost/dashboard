...
Route::group(['middleware' , 'prefix' => 'dashboard'], function () {
    ...
    Route::post('/tours/attributes/new', [TourAttrController::class, 'save_new']);
    Route::put('/tours/category/{category_id}', [TourAttrController::class, 'save_edit']);
    Route::delete('/tours/category/delete/{category_id}', [TourAttrController::class, 'delete']);
