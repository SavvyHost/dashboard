...
Route::post('/rooms/types/edit/{attr}', [CancellationPolicyController::class,'save_edit'])->name('hotel.cancel.edit.type.save');
Route::delete('/rooms/types/{attr_id}/delete', [RoomTypeController::class,'destroy'])->name('hotel.cancel.type.destroy');
