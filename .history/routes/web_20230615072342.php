...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::group(['middleware' => ['role:1']], function() {
        ...
        Route::get('/tours/attributes/edit/{attr}', [TourAttrController::class,'show'])->name('tour.edit.attr.show');
        Route::post('/tours/attributes/edit/{attr}', [TourAttrController::class,'save_edit'])->name('tour.edit.attr.save');
        ...
        Route::get('/tours/attributes/edit/term/{attr}', [TourTermController::class,'show'])->name('tour.ediot.attr.show');
        Route::post('/tours/attributes/edit/term/{attr}', [TourTermController::class,'save_edit'])->name('tour.edit.attr.save');
