...
///Hotel Policy///
        ...
        Route::get('/hotels/{hotel_id}/edit', [HousePolicyController::class,'show'])->name('hotel.policy.edit.form.show');
        Route::post('/hotels/{hotel_id}/edit', [HousePolicyController::class,'save'])->name('hotel.policy.edit.form.save');
        Route::delete('/hotels/{hotel_id}/delete', [HousePolicyController::class,'destroy'])->name('hotel.policy.destroy');
        Route::get('/hotels/attributes/new', [HousePolicyController::class,'add'])->name('hotel.attr.form.show');
        // Route::post('/hotels/attributes/new', [HousePolicyController::class,'save'])->name('hotel.attr.form.save');
        Route::get('/hotels/attributes/edit/{attr}', [HousePolicyController::class,'show'])->name('hotel.policy.edit.show');
        Route::post('/hotels/attributes/edit/{attr}', [HousePolicyController::class,'save_edit'])->name('hotel.policy.edit.save');
