...
Route::group(['middleware' , 'prefix' => 'dashboard'], function () {
    ...
    Route::delete('/tours/attributes/delete/{attributes_id}', [TourAttrController::class, 'delete']);
        ...
        ///Tour Terms///
        Route::get('/tours/terms', [TourTermController::class, 'index']);
        Route::get('/tours/attributes/{attr_id}/terms', [TourTermController::class, 'show']);
        Route::get('/tours/{hotel_id}/terms', [TourTermController::class, 'exceptions']);
        Route::post('/tours/attributes/terms/new', [TourTermController::class, 'save']);
        Route::put('/tours/attributes/terms/{attr_id}', [TourTermController::class, 'update']);
        Route::delete('tours/attributes/terms/delete/{terms_id}', [TourTermController::class, 'delete']);
