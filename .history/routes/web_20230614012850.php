...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::group(['middleware' => ['role:1']], function() {
        ...
        Route::post('/user/roles/{id}/edit', [RolesController::class,'view_edit'])->name('role_update_view');
        Route::post('/user/role/{edit}', [RolesController::class,'update'])->name('role.update.add');
