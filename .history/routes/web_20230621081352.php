...
///Hotel Policy///
        Route::get('/hotels/new', [HousePolicyController::class,'index'])->name('hotel.form.show');
        Route::post('/hotels/new', [HousePolicyController::class,'save'])->name('hotel.form.save');
