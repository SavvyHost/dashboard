...
///Tour Type///
Route::get('/tourss/types/new', [TourTypeController::class,'add'])->name('hotel.room.type.form.show');
Route::post('/tourss/types/new', [TourTypeController::class,'save'])->name('hotel.room.type.form.save');
Route::get('/tours/types', [TourTypeController::class,'index'])->name('hotel.room.type.show');
Route::get('/tours/types/edit/{attr}', [TourTypeController::class,'show'])->name('hotel.room.edit.type.show');
Route::post('/tours/types/edit/{attr}', [TourTypeController::class,'save_edit'])->name('hotel.room.edit.type.save');
Route::delete('/tours/types/{attr_id}/delete', [TourTypeController::class,'destroy'])->name('hotel.room.type.destroy');
