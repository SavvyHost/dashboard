...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::group(['middleware' => ['role:1']], function() {
        ...
        Route::get('/tours/attributes/edit/{attr}', [AttributesController::class,'show'])->name('hotel.edit.attr.show');
        Route::post('/tours/attributes/edit/{attr}', [AttributesController::class,'save_edit'])->name('hotel.edit.attr.save');
