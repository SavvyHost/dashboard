...
///Room meals///
Route::get('/rooms/meals/new', [MealController::class,'add'])->name('hotel.room.meal.form.show');
Route::post('/rooms/meals/new', [MealController::class,'save'])->name('meal.form.save');
Route::get('/rooms/meal', [MealController::class,'index'])->name('hotel.room.meal.show');
