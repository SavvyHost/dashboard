...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::group(['middleware' => ['role:1']], function() {
        Route::get('/user/role', [RolesController::class,'index'])->name('roles.show');
        ...
        Route::post('/user/role/{id}', [RolesController::class,'view_edit'])->name('role.update.show');
        // Route::post('/user/role/{id}', [RolesController::class,'index'])->name('role.update.save');
        Route::post('/user/role/edit/{id}', [RolesController::class, 'view_edit'])->name('role.edit');
        ...
        Route::get('/user/', [EditUserController::class,'index'])->name('user.edit.show');
        ...
        Route::get('/subscribers/new', [SubscribersController::class,'add'])->name('subscribers.add.form.show');
        Route::post('/subscribers/new', [SubscribersController::class,'save'])->name('subscribers.add.form.save');

        Route::post('/subscribers/{user_id}', [SubscribersController::class,'save'])->name('subscribers.update.form.show');
        Route::post('/subscribers/new', [SubscribersController::class,'save'])->name('subscribers.update.form.save');
