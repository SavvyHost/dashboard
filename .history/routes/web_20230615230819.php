...
///Hotel avl///
        ...
        Route::get('/rooms/{hotel_id}/new', [AddRoomController::class,'index'])->name('room.at.form.show');
        ...
        Route::get('/po', [RoomAttributesController::class,'index'])->name('room.attr.show');
//
//
