...
///Room Sup///
Route::get('/roomss/sups/new', [RoomSupController::class,'add'])->name('hotel.room.type.form.show');
Route::post('/roomss/sups/new', [RoomSupController::class,'save'])->name('hotel.room.type.form.save');
Route::get('/rooms/sups', [RoomSupController::class,'index'])->name('hotel.room.type.show');
Route::get('/rooms/sups/edit/{attr}', [RoomSupController::class,'show'])->name('hotel.room.edit.type.show');
Route::post('/rooms/sups/edit/{attr}', [RoomSupController::class,'save_edit'])->name('hotel.room.edit.type.save');
Route::delete('/rooms/sups/{attr_id}/delete', [RoomSupController::class,'destroy'])->name('hotel.room.type.destroy');
