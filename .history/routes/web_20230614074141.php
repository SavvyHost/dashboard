...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::group(['middleware' => ['role:1']], function() {
        ...
        Route::post('/hotels/attributes/edit/{attr}', [AttributesController::class,'save'])->name('hotel.edit.attr.save');
        ...
        Route::get('/hotels/attribute/{attr_id}/term/edit', [TermsController::class,'add'])->name('hotel.attr.terms.form.show');
        Route::post('/hotels/attribute/{attr_id}/term/edit', [TermsController::class,'save'])->name('hotel.attr.terms.form.save');
