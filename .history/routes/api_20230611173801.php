...
Route::group(['middleware' , 'prefix' => 'dashboard'], function () {
    ...
    Route::put('/hotels/{hotel_id}/availabilty/{excep_id}', [AvailabiltyController::class, 'save']);
    Route::delete('hotels/{hotel_id}/availabilty/delete/{excep_id}', [AvailabiltyController::class, 'delete']);
