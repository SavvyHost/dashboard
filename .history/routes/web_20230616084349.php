...
///Room Type///
Route::get('/rooms/types/new', [RoomTypeController::class,'add'])->name('hotel.room.type.form.show');
Route::post('/rooms/types/new', [RoomTypeController::class,'save'])->name('hotel.room.type.form.save');
