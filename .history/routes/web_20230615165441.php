...
///Hotel attr///
        ...
        Route::delete('/hotels/attribute/{attr_id}/term/delete', [AttributesController::class,'destroy'])->name('hotel.attr.terms.destroy');
...
///Hotel avl///
        ...
        // Route::get('/rooms/new', [AddRoomController::class,'index'])->name('room.form.show');
        // Route::post('/rooms/new', [AddRoomController::class,'save'])->name('room.form.save');
        // Route::get('/hotels/{hotel_id}/edit', [EditHotelController::class,'show'])->name('hotel.edit.form.show');
        // Route::post('/hotels/{hotel_id}/edit', [EditHotelController::class,'save'])->name('hotel.edit.form.save');
        // Route::delete('/hotels/{hotel_id}/delete', [HotelsController::class,'destroy'])->name('hotel.destroy');
...
///Tours terms///
        ...
        Route::delete('/tours/attributes/term/{attr}/delete', [TourTermController::class,'destroy'])->name('hotel.attr.terms.destroy');
