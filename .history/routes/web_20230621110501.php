...
///Room meals///
Route::get('/roomss/meals/new', [MealController::class,'add'])->name('hotel.room.type.form.show');
Route::post('/roomss/meals/new', [MealController::class,'save'])->name('hotel.room.type.form.save');
Route::get('/rooms/meals', [MealController::class,'index'])->name('hotel.room.type.show');
Route::get('/rooms/meals/edit/{attr}', [MealController::class,'show'])->name('hotel.room.edit.type.show');
Route::post('/rooms/meals/edit/{attr}', [MealController::class,'save_edit'])->name('hotel.room.edit.type.save');
Route::delete('/rooms/meals/{attr_id}/delete', [MealController::class,'destroy'])->name('hotel.room.type.destroy');
