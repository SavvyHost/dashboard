...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::group(['middleware' => ['role:1']], function() {
        ...
        Route::get('/hotels/attribute/{attr_id}/term/new', [TermsController::class,'view'])->name('hotel.attr.terms.form.show');
        Route::post('/hotels/attribute/{attr_id}/term/new', [TermsController::class,'save'])->name('hotel.attr.terms.form.save');
        Route::get('/hotels/attribute/{attr_id}/terms', [TermsController::class,'index'])->name('hotel.attr.terms.show');

        Route::get('/hotels/attribute/{attr_id}/term/edit', [TermsController::class,'show'])->name('hotel.attr.terms.show');
        Route::get('/hotels/attribute/{attr_id}/term/edit', [TermsController::class,'index'])->name('hotel.attr.terms.edit.show');
