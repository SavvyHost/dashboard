...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::group(['middleware' => ['role:1']], function() {
        ...
        // Route::get('/hotels/attributes/edit/{attr}', [AttributesController::class,'show'])->name('hotel.attr.show');
        Route::get('/hotels/attributes/edit/{attr}', [AttributesController::class,'index'])->name('hotel.attr.show');
