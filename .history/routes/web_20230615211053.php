...
///Hotel avl///
        ...
        // Route::get('/rooms/new', [AddRoomController::class,'index'])->name('room.at.form.show');
...
//
//
        Route::get('/rooms/attributes/new', [RoomAttributesController::class,'add'])->name('hotel.attr.form.show');
        Route::post('/rooms/attributes/new', [RoomAttributesController::class,'save'])->name('hotel.attr.form.save');
        Route::get('/rooms/attributes', [RoomAttributesCoRoomntroller::class,'index'])->name('hotel.attr.show');
        Route::get('/rooms/attributes/edit/{attr}', [RoomAttributesController::class,'show'])->name('hotel.edit.attr.show');
        Route::post('/rooms/attributes/edit/{attr}', [RoomAttributesController::class,'save_edit'])->name('hotel.edit.attr.save');
