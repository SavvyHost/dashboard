...
//
        ...
        Route::get('/rooms/attribute/{attr_id}/term/edit', [RoomTermsController::class,'edit'])->name('hotel.attr.terms.edit.show');
        Route::post('/rooms/attribute/{attr_id}/term/edit', [RoomTermsController::class,'save_edit'])->name('hotel.attr.terms.edit.save');
