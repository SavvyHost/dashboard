...
//
    ...
    public function save(Request $request, $id)
    {
        $request->validate([
            ...
            'price' => 'nullable|array', // Add the validation for the 'prices' attribute
            'price.*' => 'nullable|numeric', // If prices is an array, each item should be numeric
        ]);
        ...
        $roomData = [
            ...
            'has_meal' => $request->has_meal,
            'free_meal' => $request->free_meal,
            // 'meal_type' => $request->free_meal ? implode(',', $request->meals) : null,
            'meal_price' => $request->free_meal ? null : $request->meal_price,
