...
class BookingController extends Controller
{
    ...
    public function back_booking(Request $request)
    {
        ...
        // Retrieve the selected hotel's rooms
        $selectedHotelId = $request->input('hotel_id');
        $selectedHotelRooms = Room::where('hotel_id', $selectedHotelId)->get();

        return view('booking.back-booking-list', compact('hotels', 'users','rooms', 'selectedHotelId', 'selectedHotelRooms'));
    }
