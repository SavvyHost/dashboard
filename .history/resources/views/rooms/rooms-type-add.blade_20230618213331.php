<x-layout.default>
    ...
    <div >
        <ul class="flex space-x-2 rtl:space-x-reverse">
            <li>
                <a href="{{route('hotel.room.type.show')}}" class="text-primary hover:underline">Types</a>
            </li>
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    ...
                    <form class="space-y-5" method="POST" action="{{route('hotel.room.type.form.save')}}" enctype="multipart/form-data">
                        ...
                        <div class="flex sm:flex-row flex-col ">
                            <label for="attrName" class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Type Price</label>
                            <input id="attrName" type="text"  placeholder="Enter Attribute Name"
                                class="form-input flex-1" name="name" required />
                        </div>
                        <div class="flex sm:flex-row flex-col ">
                            <label for="attrName" class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Enter Numbers Of Beds</label>
                            <input id="attrName" type="text"  placeholder="Enter Attribute Name"
                                class="form-input flex-1" name="name" required />
                        </div>
