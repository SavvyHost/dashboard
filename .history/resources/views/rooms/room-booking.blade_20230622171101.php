                ...
                <form action="{{ route('booking.store') }}" method="POST">
                            ...
                            <div>
                                <!-- Booking Inputs -->
                                    ...
                                    <input type="hidden" name="payment_method" value="{{$room->price}}">

                                    <div>
                                        <label for="check_in">Check-in:</label>
                                        <input type="date" name="check_in" id="start_date" required>
                                    </div>

                                    <div>
                                        <label for="check_out">Check-out:</label>
                                        <input type="date" name="check_out" id="end_date" required>
                                    </div>
