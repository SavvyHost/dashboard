        ...
        <div class="flex items-center justify-between flex-wrap gap-4">
            ...
            <div class="flex sm:flex-row flex-col sm:items-center sm:gap-3 gap-4 w-full sm:w-auto">
                <div class="flex gap-3">
                    ...
                    <div>
                        <a href={{ url('/rooms/attribute/' . $attr->id . '/terms/new') }}       {{-- "{{route('hotel.attr.terms.form.show',$attr->id)}}" --}} role="button" class="btn btn-primary" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <td>
                                        <form id="delete-form-{{ $term->id }}" action="{{ route('room.attr.terms.destroy', $term->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            {{-- <button type="submit" class="btn btn-sm btn-outline-danger" >Delete</button> --}}
                                        </form>
                                        <div class="flex gap-4 items-center ">
                                            <a href="{{url('/rooms/attribute/'.$term->id.'/terms/edit',)}}" role="button" class="btn btn-sm btn-outline-primary">Edit</a>
