        ...
        <div class="flex items-center justify-between flex-wrap gap-4">
            ...
            <div class="flex sm:flex-row flex-col sm:items-center sm:gap-3 gap-4 w-full sm:w-auto">
                <div class="flex gap-3">
                    ...
                    <div>
                        <a href="{{route('hotel.room.sup.form.show')}}" role="button" class="btn btn-primary" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                <form id="delete-form-{{ $at->id }}" action="{{ route('hotel.room.sup.destroy', $at->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                                <div class="flex gap-4 items-center ">
                                                    <a href="{{route('hotel.room.edit.sup.show',$at->id)}}" role="button" class="btn btn-sm btn-outline-primary">Edit</a>
                                                    {{-- <a href="{{route('hotel.room.sup.destroy',$at->id)}}" role="button" class="btn btn-sm btn-outline-success">Manage Terms</a> --}}
