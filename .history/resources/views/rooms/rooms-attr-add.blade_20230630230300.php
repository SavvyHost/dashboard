        ...
        <div class="pt-5 grid grid-cols-1 lg:grid-cols-1 gap-6">
            <div class="panel">
                <div class="flex items-center justify-between mb-5">
                    ...
                    <h5 class="font-semibold text-lg dark:text-white-light">Enter Attribute Details</h5>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <form class="space-y-5" method="POST" action="{{route('hotel.room.attr.form.save')}}" enctype="multipart/form-data">
                        @csrf
