    ...
    <div >
        <div>
            ...
            <ul class="flex space-x-2 rtl:space-x-reverse">
                ...
                <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                    <a href="{{route('hotel.room.attr.terms.show',$terms->attr_id)}}" class="text-primary hover:underline">{{$terms->atts->name}}</a>
                </li>
                <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
        ...
        <div class="pt-5 grid grid-cols-1 lg:grid-cols-1 gap-6">
            <div class="panel">
                ...
                <div class="mb-5">
                    ...
                    <form class="space-y-5" method="POST" action="{{url('/rooms/attribute/'.$terms->id.'/term/edit',)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="flex sm:flex-row flex-col ">
                            <label for="attrName" class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Term Edit</label>
                            <input id="attrName" type="text"  placeholder="Enter Term Name"
                                class="form-input flex-1" name="name" required />
                        </div>
                        <div class="flex sm:flex-row flex-col ">
                            <label for="attrPrice" class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Term Edit</label>
