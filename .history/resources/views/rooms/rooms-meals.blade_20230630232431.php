<x-layout.default>
    ...
    <div x-data="Meals">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                <h2 class="text-xl">Room Meals</h2>
                <ul class="flex space-x-2 rtl:space-x-reverse">
                    <li>
                        <a href="{{route('hotels.show')}}" class="text-primary hover:underline">Hotels</a>            </li>
                    <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                        <a href="{{route('hotel.room.meal.show')}}" class="text-primary hover:underline">Meals</a>
                    </li>
            ...
            <div class="flex sm:flex-row flex-col sm:items-center sm:gap-3 gap-4 w-full sm:w-auto">
                <div class="flex gap-3">
                    ...
                    <div>
                        <a href="{{route('hotel.room.meal.form.show')}}" role="button" class="btn btn-primary" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                <form id="delete-form-{{ $at->id }}" action="{{ route('hotel.room.meal.destroy', $at->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    {{-- <button type="submit" class="btn btn-sm btn-outline-danger" >Delete</button> --}}
                                                </form>
                                                <div class="flex gap-4 items-center ">
                                                    <a href="{{route('hotel.room.edit.meal.show',$at->id)}}" role="button" class="btn btn-sm btn-outline-primary">Edit</a>
