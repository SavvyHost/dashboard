                ...
                <div class="flex-1">
                    <div class="space-y-1 text-white-dark">
                        @if($bookingItem->customer_details)
                            <h3>Customer:</h3>
                            <div class="text-black dark:text-white font-semibold">{{ $bookingItem->customer_details->name }}</div>
                            <div>{{ $bookingItem->customer_details->address }}</div>
                            <div>{{ $bookingItem->customer_details->email }}</div>
                            <div>{{ $bookingItem->customer_details->phone }}</div>
                        @else
