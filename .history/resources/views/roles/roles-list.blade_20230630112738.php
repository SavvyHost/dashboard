                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex gap-4 items-center">
                                            ...
                                            <div class="flex gap-4 items-center">
                                                <a href="{{ route('role.update.form.show', $role->id) }}" role="button" class="btn btn-sm btn-outline-primary">Edit</a>
                                                <a href="#" role="button" class="btn btn-sm btn-outline-danger" @click="showAlert(event, {{ $role->id }})">Delete</a>

                                                {{-- <a href="#" role="button" class="btn btn-sm btn-outline-danger"  @click="showAlert()" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $role->id }}').submit();">Delete</a> --}}
                                            </div>
                                        </div>
...
<script>
   async function showAlert(event, roleId) {
