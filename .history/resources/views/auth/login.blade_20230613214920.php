    ...
    <div x-data="contacts" x-init="init">
        <div class="flex items-center justify-between flex-wrap gap-4">
            ...
            <div class="flex sm:flex-row flex-col sm:items-center sm:gap-3 gap-4 w-full sm:w-auto">
                ...
                <div class="relative">
                    <input type="text" placeholder="Search Users" class="form-input py-2 ltr:pr-11 rtl:pl-11 peer" x-model="searchUser" x-on:input="searchContacts" />
            ...
            <template x-if="displayType === 'list'">
                <div class="table-responsive">
                    <table class="table-striped table-hover">
                        ...
                        <tbody>
                            <template x-for="user in filterdContactsList" :key="user.id">
                                <tr>
                                    <td>
                                    ...
                                    <td class="whitespace-nowrap" x-text="user.phone"></td>
                                    <td>
