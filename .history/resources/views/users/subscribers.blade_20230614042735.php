        ...
        <div class="flex items-center justify-between flex-wrap gap-4">
            ...
            <div class="flex sm:flex-row flex-col sm:items-center sm:gap-3 gap-4 w-full sm:w-auto">
                <div class="flex gap-3">
                    <div>
                        <a href="{{route('subscriber.add.form.show')}}" role="button" class="btn btn-primary" >
                    ...
                    <table class="table-striped table-hover">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form id="delete-form-{{$subscriber->id}}" action="{{ route('subscriber.destroy', $subscriber->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                        <div class="flex gap-4 items-center ">
                                            <a href="{{ route('subscriber.update.form.show', $subscriber->id) }}" role="button" class="btn btn-sm btn-outline-primary">Edit</a>
                                            <a href="#" role="button" class="btn btn-sm btn-outline-danger" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $subscriber->id }}').submit();">Delete</a>
