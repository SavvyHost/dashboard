            ...
            <div x-data="{ tab: 'home' }">
                ...
                <template x-if="tab === 'home'">
                    <div>
                        ...
                        <form method="POST" action="{{route('subscribers.update.form.save',$subscribers->id)}}"
                            class="border border-[#ebedf2] dark:border-[#191e3a] rounded-md p-4 mb-5 bg-white dark:bg-[#0e1726]">@endforeach
                            @csrf
