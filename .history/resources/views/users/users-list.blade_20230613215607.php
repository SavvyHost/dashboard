                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex gap-4 items-center ">
                                            ...
                                            {{-- <a href="{{route('user.edit.show',$user->id)}}" role="button" class="btn btn-sm btn-outline-danger">Delete</a> --}}
                                            <a href="{{ route('user.delete', $user->id) }}" role="button" class="btn btn-sm btn-outline-danger" onclick="event.preventDefault(); deleteConfirm({{ $user->id }});">Delete</a>
