                            ...
                            <tr>
                                <td>
                                    <div class="flex items-center w-max">
                                        <div> <a href="{{route('spec.hotel.availabilty.show',$hotel->id)}}" class="text-primary">{{$hotel->name}}</a> </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <div class="flex gap-4 items-center ">
                                        <a href="{{route('hotels.availabilty.edit.form.show',$hotel->id)}}" role="button" class="btn btn-sm btn-outline-primary">Edit</a>
