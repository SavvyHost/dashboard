...
#progressbar li:before {
  content: attr(data-step-name); /* Use the 'data-step-name' attribute as content */
  width: 100%; /* Update the width to 100% */
  line-height: 20px;
  display: block;
  font-size: 10px;
  color: white; /* Set the text color to white */
  background: #27AE60; /* Set the background color to green */
  border-radius: 3px;
  margin: 0 auto 5px auto;
  padding: 0 5px; /* Add padding to create some spacing around the step name */
