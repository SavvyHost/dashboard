            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    ...
                    <form id="multi-step-form" class="space-y-5" method="POST" action="{{ route('hotel.form.save') }}" enctype="multipart/form-data">
                        <div id="progressbar">
                            <ul>
                                <li data-step-name="Hotel" class="active"></li>
                                <li data-step-name="Policies" ></li>
                                <li data-step-name="Attributes"></li>
                                <li data-step-name="Terms"></li>
                            </ul>
                        </div>
                        ...
                        <fieldset  class="form-step" id="step-1">
                                {{-- <div id="step-1" class="form-step"> --}}
                                    ...
                                    <div class="flex sm:flex-row flex-col ">
                                        ...
                                        <div>
                                            @foreach ($attrs as $ar)
                                                <div class="w-full attribute-group">
                                                    <legend style="font-size: larger; font-weight: bold;">{{ $ar->name }}</legend>
                                                    <div class="term-container">
                                                        @foreach ($ar->terms as $term)
                                                            <div class="term">
                                                                <input type="checkbox" id="{{$term->id}}" name="terms[]" value="{{$term->id}}">
                        ...
                        <fieldset  id="step-2" style="display: none" class="form-step">
                            ...
                            <div class="flex sm:flex-row flex-col ">
                                ...
                                <button type="button" class="submit">PreviDsubmetous</button>
