        ...
        <div class="pt-5 grid grid-cols-1 lg:grid-cols-1 gap-6">
            <div class="panel">
                ...
                <div class="mb-5">
                    ...
                    <form id="step-1" class="space-y-5" method="POST" action="{{route('hotel.policy.form.save',$hotel_id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="flex sm:flex-row flex-col ">
                     ...
                     <form id="step-2" class="space-y-5" method="POST" action="{{route('hotel.attr.form.save')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="flex sm:flex-row flex-col ">
                    ...
                    <form id="step-3" class="space-y-5" method="POST" action="{{route('hotel.attr.terms.form.save',$attr_id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="flex sm:flex-row flex-col ">
