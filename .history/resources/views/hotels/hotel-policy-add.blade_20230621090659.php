<x-layout.default>
    ...
    <div >
        <ul class="flex space-x-2 rtl:space-x-reverse">
            <li>
                <a href="#" class="text-primary hover:underline">Hotels</a>
            </li>
        ...
        <div class="pt-5 grid grid-cols-1 lg:grid-cols-1 gap-6">
            <div class="panel">
                ...
                <div class="mb-5">
                    <form class="space-y-5" method="POST" action="/hotel/policy/{{ $hotel_id }}/new" enctype="multipart/form-data">

                    {{-- <form class="space-y-5" method="POST" action="{{route('hotel.policy.form.save',$hotel_id)}}" enctype="multipart/form-data"> --}}
                        @csrf
