...
<x-layout.default>
    ...
    <div >
        ...
        <ul class="flex space-x-2 rtl:space-x-reverse">
            ...
            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                <a href="{{ route('hotel.rooms.show', $room->hotels->id) }}" class="text-primary hover:underline">
                    {{ \App\Models\Hotel::find($room->hotels->id)->name }}
                </a>            </ul>
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    ...
                    <form class="space-y-5" method="POST" action="{{route('room.form.save',$id)}}" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <div class="flex sm:flex-row flex-col">
                                <div class="w-full" style="margin-right: 10px">
                                    ...
                                    <input id="has_meal" type="checkbox" name="has_meal" onchange="toggleMealOptions(this); this.value = this.checked ? 'true' : 'false'" />
                                </div>
                            </div>
                            ...
                            <div id="mealOptions" style="display: none;">
                                <div class="flex sm:flex-row">
                                    <div class="w-full" style="margin-right: 10px">
                                        ...
                                        <div class="flex">
                                            <input id="free_meal_yes" type="radio" name="free_meal" value="1" onchange="toggleFreeMealOptions(this)" />
                                            <label for="free_meal_yes">Yes</label>
                                        </div>
                                        <div class="flex">
                                            <input id="free_meal_no" type="radio" name="free_meal" value="0" onchange="toggleFreeMealOptions(this)" />
                                            <label for="free_meal_no">No</label>
                                        </div>
                                    </div>
                                </div>

                                {{-- <div id="mealSelection" style="display: none;">
                                    <div class="w-full" style="margin-right: 10px">
                                        <label for="meal_id">Select Meal</label>
                                        <select class="selectize" name="meal_id[]">
                                ...
                                <div id="mealSelection" style="display: none;">
                                    <div class="w-full" style="margin-right: 10px">
                                        ...
                                        <select class="selectize" name="meal_id[]" multiple = 'multiple'>
                                ...
                                <div id="mealPrice" style="display: none;">
                                    <div class="w-full" style="margin-right: 10px">
                        ...
                        <div>
                            <div class="flex sm:flex-row flex-col">
                                <label for="currency" class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Currency</label>
                                <select id="currency" name="currency" class="form-select flex-1" required>
    ...
    <script>
        function toggleMealOptions(checkbox) {
                    var mealOptions = document.getElementById("mealOptions");
                    mealOptions.style.display = checkbox.checked ? "block" : "none";
                }

                function toggleMealPriceField(checkbox) {
                    var mealPriceField = document.getElementById("meal_price");
                    mealPriceField.disabled = checkbox.checked;
                    mealPriceField.value = ""; // Clear the field value when it is disabled
                }
    ...
    <script>
        function toggleMealOptions(checkbox) {
                    ...
                    if (!checkbox.checked) {
                        resetFreeMealOptions();
                    }
                }

                function toggleFreeMealOptions(radio) {
                    var mealSelection = document.getElementById("mealSelection");
                    var mealPrice = document.getElementById("mealPrice");

                    if (radio.value === "1") {
                        mealSelection.style.display = "block";
                        mealPrice.style.display = "none";
                    } else {
                        mealSelection.style.display = "none";
                        mealPrice.style.display = "block";
                    }
                }

                function resetFreeMealOptions() {
                    var mealSelection = document.getElementById("mealSelection");
                    var mealPrice = document.getElementById("mealPrice");

                    mealSelection.style.display = "none";
                    mealPrice.style.display = "none";
                    mealSelection.querySelector("select").selectedIndex = 0;
                    mealPrice.querySelector("input").value = "";
                }
