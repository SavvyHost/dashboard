                ...
                <div class="mb-5">
                    ...
                    <form class="space-y-5" method="POST" action="{{route('room.form.save',$id)}}" enctype="multipart/form-data">
                        ...
                        {{-- <div style="display: flex; align-items: center;">
                            <button class="btn btn-primary !mt-6" onclick="calculateAndShowTotal()">Calculate Total</button>
                        ...
                        <div style="display: flex; align-items: center;">
                            ...
                            {{-- <label for="total" class="btn btn-primary !mt-6" style="margin-left: 10px;">Total:</label> --}}
