            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    ...
                    <form class="space-y-5" method="POST" action="{{route('room.form.save',$id)}}" enctype="multipart/form-data">
                        ...
                        <div><div x-ref="radialBarChart" class="bg-white dark:bg-black rounded-lg"></div>
                        </div>
                        <div class="flex sm:flex-row flex-col ">
                        ...
                        <div x-data="chart" x-init="init()" class="bg-white dark:bg-black rounded-lg">
                            ...
                            <div>Total Price:{{$totalPrice }} <span x-text="totalPrice"></span></div>
                        </div>
...
<script>
    document.addEventListener("alpine:init", () => {
        Alpine.data("chart", () => ({
            $totalPrice: 249, // Update with the actual total price value

            init() {
                let isDark = this.$store.app.theme === "dark" ? true : false;
            ...
            get radialBarChartOptions() {
                return {
                    series: [this.$totalPrice], // Use $totalPrice variable
                    chart: {
                        height: 300,
                        type: 'radialBar',
                        zoom: {
                        ...
                        radialBar: {
                            dataLabels: {
                                ...
                                total: {
                                    show: true,
                                    label: 'Total',
                                    formatter: () => this.$totalPrice // Use $totalPrice variable
                                }
                            }
                        }
                    },
