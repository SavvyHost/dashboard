<x-layout.default>
    ...
    <div x-data="hotels">
        <h2 class="text-xl">Hotels Attributes</h2>
            ...
            <div>
                <ul class="flex space-x-2 rtl:space-x-reverse">
                    ...
                    <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                        <a href="{{route('hotels.availabilty.show')}}" class="text-primary hover:underline">Attributes</a>
                    </li>
                </ul>
            </div>
            <div class="flex sm:flex-row flex-col sm:items-center sm:gap-3 gap-4 w-full sm:w-auto">
                <div class="flex gap-3">
                    ...
                    <div>
                        ...
                        <a href="{{route('hotel.attr.form.show')}}" role="button" class="btn btn-primary" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <td>
                                        <form id="delete-form-{{ $at->id }}" action="{{ route('hotel.attr.destroy', $at->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            {{-- <button type="submit" class="btn btn-sm btn-outline-danger" >Delete</button> --}}
                                        </form>
                                        <div class="flex gap-4 items-center ">
                                            <a href="{{route('hotel.edit.attr.show',$at->id)}}" role="button" class="btn btn-sm btn-outline-primary">Edit</a>
                                            <a href="{{route('hotel.attr.terms.show',$at->id)}}" role="button" class="btn btn-sm btn-outline-success">Manage Terms</a>
