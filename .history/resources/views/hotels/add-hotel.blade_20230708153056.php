        ...
        <div class="pt-5 grid grid-cols-1 lg:grid-cols-1 gap-6">
            <div class="panel">
                ...
                <div class="nav nav-fill my-3">
                    <label calss = "nav-link shadow-sm step-1 border ml-2 ">Step one</label>
                    <label calss = "nav-link shadow-sm step-2 border ml-2 ">Step two</label>
                    <label calss = "nav-link shadow-sm step-3 border ml-2 ">Step three</label>
                    <label calss = "nav-link shadow-sm step-4 border ml-2 ">Step four</label>
