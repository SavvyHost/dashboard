...
<x-layout.default>
                ...
                <div class="mb-5">
                    ...
                    <form class="space-y-5" method="POST" action="{{route('room.form.save',$id)}}" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <div>
                                <div>
                                    <button onclick="calculateAndShowTotal()">Calculate Total</button>
    ...
    <script>
        function calculateTotal() {
            var termsSelect = document.getElementsByName('terms[]')[0];
            var typeSelect = document.getElementsByName('type')[0];
            var supsSelect = document.getElementsByName('sups[]')[0];
            var totalSpan = document.getElementById('total');

            var termsTotal = calculateSelectTotal(termsSelect);
            var typeTotal = parseFloat(typeSelect.value);
            var supsTotal = calculateSelectTotal(supsSelect);

            var total = termsTotal + typeTotal + supsTotal;
        ...
        var termsSelect = document.getElementsByName('terms[]')[0];
        termsSelect.addEventListener('change', calculateTotal);

        var typeSelect = document.getElementsByName('type')[0];
        typeSelect.addEventListener('change', calculateTotal);

        var supsSelect = document.getElementsByName('sups[]')[0];
        supsSelect.addEventListener('change', calculateTotal);
    </script>
