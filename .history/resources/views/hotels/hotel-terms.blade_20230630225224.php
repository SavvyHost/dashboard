                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <td>
                                        <form id="delete-form-{{ $term->id }}" action="{{ route('hotel.attr.terms.destroy', $term->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            {{-- <button type="submit" class="btn btn-sm btn-outline-danger" >Delete</button> --}}
                                        </form>
                                        <div class="flex gap-4 items-center ">
                                            <a href="{{route('hotel.attr.terms.edit.show',$term->id)}}" role="button" class="btn btn-sm btn-outline-primary">Edit</a>
                                            ...
                                            <a href="#" role="button" class="btn btn-sm btn-outline-danger" onclick="showAlert('{{ $term->id }}')">Delete</a>
