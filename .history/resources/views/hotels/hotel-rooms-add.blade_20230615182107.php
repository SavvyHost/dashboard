        ...
        <div class="pt-5 grid grid-cols-1 lg:grid-cols-1 gap-6">
            <div class="panel">
                ...
                <div class="mb-5">
                    ...
                    <form class="space-y-5" method="POST" action="{{route('room.form.save',$hotel_id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="flex sm:flex-row flex-col ">
                            <label for="RoomName" class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Room Name</label>
                            <input id="RoomName" type="text"  placeholder="Enter Room Name"
                                class="form-input flex-1" name="room_name" required />
                        </div>
                        <div class="flex sm:flex-row flex-col ">
                            <label for="MaxAdult" class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Max Adult</label>
                            <input id="MaxAdult" type="text"  placeholder="Enter Max Adult"
                                class="form-input flex-1" name="max_adult" required />
                        </div>
                        <div class="flex sm:flex-row flex-col ">
                            <label for="MaxChild" class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Max Child</label>
                            <input id="MaxChild" type="text"  placeholder="Enter Max Child"
                                class="form-input flex-1" name="max_child" required />
                        </div>
                        <div class="flex sm:flex-row flex-col ">
                            <label for="RoomPrice" class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Room Price</label>
                            <input id="RoomPrice" type="text"  placeholder="Enter Room Price"
                                class="form-input flex-1" name="room_price" required />
                        </div>
                        <div class="flex sm:flex-row flex-col ">
