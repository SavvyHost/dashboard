                ...
                <div class="mb-5">
                    <div class="step-navigation">
                        <a href="#step-1" class="step-link">
                            <span class="step-label step-1 active">Step one</span>
                        </a>
                        <a href="#step-2" class="step-link">
                            <span class="step-label step-2">Step two</span>
                        </a>
                        <a href="#step-3" class="step-link">
                            <span class="step-label step-3">Step three</span>
                        </a>
                        <a href="#step-4" class="step-link">
                            <span class="step-label step-4">Step four</span>
                        </a>
                    </div>
...
.step-navigation label:last-child:before {
    display: none;
}
...
.step-navigation label.active:before {
    background-color: #4caf50;
}

.step-navigation label:not(.active):hover {
    background-color: #e0e0e0;
}

.step-navigation label:not(.active):hover:before {
    background-color: #e0e0e0;
}

.step-navigation label:not(.active):after {
    content: '';
    position: absolute;
    top: 50%;
    left: 100%;
