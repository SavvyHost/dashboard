    ...
    <script>
        function initAutocomplete() {
            ...
            addLocationBtn.addEventListener('click', function() {
                ...
                // Clone the first location row
                var newLocation = locationsContainer.querySelector('.row:first-child').cloneNode(true);

                // Increment input name and ID attributes
                newLocation.querySelectorAll('.additional-location').forEach(function(element) {
                    var name = element.getAttribute('name');
                    var newName = name.replace('[]', '[' + locationsContainer.childElementCount + ']');
                    element.setAttribute('name', newName);

                    var id = element.getAttribute('id');
                    var newId = id + locationsContainer.childElementCount;
