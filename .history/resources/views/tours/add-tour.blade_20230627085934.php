<x-layout.default>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB-1SBXGvL7VPTUJw8Z3SEx1f1ALl9jAbc&libraries=places&callback=initAutocomplete&language=ar&region=EG
         async defer"></script>
</x-layout.default>
