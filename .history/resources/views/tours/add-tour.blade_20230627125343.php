            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    ...
                    <form class="space-y-5" method="POST" action="{{route('tour.form.save')}}">
                        ...
                        <div class="content">
                            <form action="{{ route('tour.form.save') }}" method="post">
                                @csrf
                                <div class="mapform" >
                                    <div class="row">
                                        <div class="col-5">
                                    ...
                                    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDKZAuxH9xTzD2DLY2nKSPKrgRi2_y0ejs&libraries=places&callback=initAutocomplete&language=ar&region=EG"
