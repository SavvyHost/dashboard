<x-layout.default>
    ...
    <script>
        ...
        addLocationBtn.addEventListener('click', function() {
          // Create a new map container and map element
          var newMapContainer = document.createElement('div');
          newMapContainer.classList.add('map-container');

          var newMap = document.createElement('div');
          newMap.setAttribute('id', 'map');
          newMap.style.height = '500px';
          newMap.style.width = '1000px';

          // Append the new map container and map element to the existing mapsContainer
          var mapsContainer = document.getElementById('mapsContainer');
          mapsContainer.appendChild(newMapContainer);
          newMapContainer.appendChild(newMap);

          // Call the initAutocomplete function to initialize the new map
          initAutocomplete();
        });
      ...
      </script><script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDKZAuxH9xTzD2DLY2nKSPKrgRi2_y0ejs&libraries=places&callback=initAutocomplete&language=ar&region=EG
    async defer"></script>
</x-layout.default>
