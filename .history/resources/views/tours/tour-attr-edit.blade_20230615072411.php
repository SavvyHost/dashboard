<x-layout.default>
    ...
    <div >
        <ul class="flex space-x-2 rtl:space-x-reverse">
            {{-- <li>
                <a href="{{route('hotels.show')}}" class="text-primary hover:underline">Attributes</a>
            </li> --}}
        ...
        <div class="pt-5 grid grid-cols-1 lg:grid-cols-1 gap-6">
            <div class="panel">
                ...
                <div class="mb-5">
                    ...
                    <form class="space-y-5" method="POST" action="{{route('tour.edit.attr.save',$attr->id)}}" enctype="multipart/form-data">
                        @csrf
