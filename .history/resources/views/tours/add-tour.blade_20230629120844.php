    ...
    $(document).ready(function() {
            ...
            var locations = [];
                ...
                function addLocationFields() {
                    var locationInput = document.getElementById('pac-input').value;
                    ...
                    if (locationInput && latitudeInput && longitudeInput) {
                        ...
                        latitudes.push(latitudeInput);
                        longitudes.push(longitudeInput);

                        // Clear input fields for next location
                        document.getElementById('pac-input').value = '';
                        document.getElementById('latitude').value = '';
                        document.getElementById('longitude').value = '';
                    }

                    // Optional: Display added locations
                    var locationsList = document.getElementById('added-locations');
                    locationsList.innerHTML = '';

                    for (var i = 0; i < locations.length; i++) {
                        var listItem = document.createElement('li');
                        listItem.textContent = locations[i];
                        locationsList.appendChild(listItem);
                    }
                }

                // Call addLocationFields() function when a button or event triggers the addition of a location

                // Example: Add a button to trigger adding a location
                document.getElementById('add-location-btn').addEventListener('click', addLocationFields);
