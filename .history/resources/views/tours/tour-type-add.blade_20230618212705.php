<x-layout.default>
    ...
    <div >
        <ul class="flex space-x-2 rtl:space-x-reverse">
            <li>
                <a href="{{route('tour.type.show')}}" class="text-primary hover:underline">Types</a>
            </li>
        ...
        <div class="pt-5 grid grid-cols-1 lg:grid-cols-1 gap-6">
            <div class="panel">
                ...
                <div class="mb-5">
                    ...
                    <form class="space-y-5" method="POST" action="{{route('tour.type.form.save')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="flex sm:flex-row flex-col ">
                            <label for="price" class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Tour Price</label>
