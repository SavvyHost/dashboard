    ...
    <div>
        ...
        <div class="pt-5">
            <div class="flex items-center justify-between mb-5">
                <h5 class="font-semibold text-lg dark:text-white-light">New Subfeature</h5>
            </div>
                    ...
                    <div class="flex flex-col sm:flex-row">
                        <div class="flex-1 gap-5">
                            ...
                            <div>
                                ...
                                <select name="feature_id" id="feature_id" class="form-input">
