            ...
            <form method="post" action="{{route('pages.page.store')}}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-12 gap-5">
                    ...
                    <div class="col-span-3">
                        ...
                        <div
                            class="border border-gray-200  dark:border-[#191e3a] rounded-md  mb-5 bg-white dark:bg-[#0e1726]">
                            <div class=" border-gray-200 border-b p-2 "><strong class="p-1">Header Style</strong></div>
                            <div class="grid grid-cols-12 p-4 border-gray-200  ">
                                ...
                                <div class="col-span-12 py-1 ">
                                    ...
                                    <div class="flex flex-col ">
                                        <div class="p-1">
                                            <label class="">
                                                <input type="radio" name="header_style" value="normal"
                                        ...
                                        <div class="p-1">
                                            <label class="">
                                                <input type="radio" name="header_style" value="transparent"
                                                    class="form-radio" />
