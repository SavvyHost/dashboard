		...
		<div class="flex items-center justify-between flex-wrap gap-4">
			...
			<div class="flex sm:flex-row flex-col sm:items-center sm:gap-3 gap-4 w-full sm:w-auto">
				<div class="flex gap-3">
					<div>
						<a href="{{route('pages.page.create')}}" role="button" class="btn btn-primary">
			...
			<div class="table-responsive">
				<table class="table-striped table-hover">
					...
					@foreach ($pages as $page)
						<tr>
							<td>
								<a href="{{ route('pages.page.show', $page->id) }}">{{ $page->name }}</a>
							</td>
							...
							<td>
								...
								<div class="flex gap-4 items-center">
									<a href="{{ route('pages.page.edit', $page->id) }}" role="button"
									   class="btn btn-sm btn-outline-primary">Edit</a>
									<a href="#" role="button" class="btn btn-sm btn-outline-danger"
									   onclick="showAlert(event, '{{ $page->id }}')">Delete</a>
									<a href="{{ route('pages.page.build', $page->id) }}" role="button" class="btn btn-sm btn-outline-info">Builder</a>

									{{-- <a href="#" role="button" class="btn btn-sm btn-outline-danger" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $page->id }}').submit();">Delete</a> --}}
								</div>
