                        ...
                        <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                            ...
                            <div class="dataTable-container">
                                <table id="myTable" class="whitespace-nowrap dataTable-table">
                                        <thead>
                                                <tr>
                                                    {{-- <th data-sortable="false" style="width: 8.35725%;"><input type="checkbox" id="all" onclick="check()" class="form-checkbox"></th> --}}
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" class="all form-checkbox mt-1" :id="'chk' + {{ $user->id }}" :value="({{ $user->id }})" x-model.number="selectedRows">
                                                        </td>
