			...
			<div class="flex justify-between items-center px-4 py-3">
				<a href="/" class="main-logo flex items-center shrink-0">
					<img class="w-8 ml-[5px] flex-none" src="/assets/images/logo.svg"
						 alt="image"/>
					<span
							class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">StayExpo</span>
				</a>
				<a href="javascript:"
					...
					<ul>
						...
						<li class="menu nav-item">
							...
							<ul x-cloak x-show="activeDropdown === 'rooms'" x-collapse class="sub-menu text-gray-500">
								<li>
									...
									<a href="{{route('hotel.room.type.show')}}">Types</a>
									<a href="{{route('room.attr.show')}}">Attributes</a>
									<a href="{{route('hotel.room.sup.show')}}">Suppliement</a>
									<a href="{{route('hotel.room.meal.show')}}">Meals</a>
									{{--
									"{{route('room.category.show')}}"
									--}}
								</li>
							</ul>
						</li>
						...
						{{-- <li class="menu nav-item">
							...
							<ul x-cloak x-show="activeDropdown === 'tours'" x-collapse class="sub-menu text-gray-500">
								<li>
									...
									<a href="{{route('tour.type.show')}}">Types</a>
						...
						<li class="menu nav-item">
							...
							<ul x-cloak x-show="activeDropdown === 'booking'" x-collapse class="sub-menu text-gray-500">
								<li>
									...
									<a href="{{route('book.mine.show')}}">My Bookings</a>
									<a href="{{route('book.back.show')}}">Back Office Booking</a>
								</li>
							</ul>
						</li>
						...
						<li class="menu nav-item">
							...
							<ul x-cloak x-show="activeDropdown === 'pages'" x-collapse class="sub-menu text-gray-500">
								<li>
									{{--                                    <a href="{{route('pages.template.index')}}">Templates</a>--}}
									<a href="{{route('pages.page.index')}}">Pages</a>
									<a href="{{route('pages.section.index')}}">Sections</a>
								</li>
							</ul>
						</li>
						...
						<li class="menu nav-item">
							<button type="button" class="nav-link group"
								...
								<div class="flex items-center">
									...
									<span
											class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Features</span>
								</div>
								<div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'features' }">
							...
							<ul x-cloak x-show="activeDropdown === 'features'" x-collapse
								class="sub-menu text-gray-500">
								<li>
									<a href="{{route('feature.index')}}">Features</a>
									<a href="{{route('subfeature.index')}}">Sub Features</a>
								</li>
							</ul>
						</li>
						...
						<li class="menu nav-item">
							<button type="button" class="nav-link group"
								...
								<div class="flex items-center">
									...
									<span
											class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Partners</span>
								</div>
						...
						<li class="menu nav-item">
							<button type="button" class="nav-link group"
									:class="{ 'active': activeDropdown === 'blogs' }"
									@click="activeDropdown === 'blogs' ? activeDropdown = null : activeDropdown = 'blogs'">
								<div class="flex items-center">
									...
									<span
											class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Blogs</span>
								</div>
						...
						<li class="menu nav-item">
							<button type="button" class="nav-link group"
								...
								<div class="flex items-center">
									...
									<span
											class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">events</span>
								</div>
