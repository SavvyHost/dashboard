...
{{--                                    <a href="{{route('pages.template.index')}}">Templates</a>--}}
                        ...
                        <li class="menu nav-item">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'features'" x-collapse class="sub-menu text-gray-500">
                                <li>
                        ...
                        <li class="menu nav-item">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'partners'" x-collapse class="sub-menu text-gray-500">
                                <li>
