        ...
        <div class="flex items-center justify-between flex-wrap gap-4">
            ...
            <div class="flex sm:flex-row flex-col sm:items-center sm:gap-3 gap-4 w-full sm:w-auto">
                ...
                <div class="mb-5 flex items-center gap-2">
                    ...
                    <a href="{{route('event.create')}}" class="btn btn-primary gap-2">
                                ...
                                <table id="myTable" class="whitespace-nowrap dataTable-table">
                                        <thead>
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" class="form-checkbox mt-1" :id="'chk' + {{ $event->id }}" :value="({{ $event->id }})" x-model.number="selectedRows">
                                                        </td>
                                                        {{-- <td>
                                                        ...
                                                        <td >{{$event->id}}</td>
                                                        <td>
                                                            <a href="{{ route('event.edit', $event->id) }}" class="hover:text-info" >
                                                        ...
                                                        <td>
                                                            <form id="delete-form-{{ $event->id }}" action="{{ route('event.destroy', $event->id) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
                                                            <div class="flex gap-4 items-center">
                                                                ...
                                                                <a href="{{ route('event.destroy', $event->id) }}"  class="hover:text-danger" onclick="showAlert(event, '{{ $event->id }}') , @click="deleteRow(1)" >
