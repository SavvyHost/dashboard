        ...
        <div class="flex items-center justify-between flex-wrap gap-4">
            ...
            <div class="flex sm:flex-row flex-col sm:items-center sm:gap-3 gap-4 w-full sm:w-auto">
                ...
                <div class="mb-5 flex items-center gap-2">
                    ...
                    <a href="{{route('create.category')}}" class="btn btn-primary gap-2">
                                ...
                                <table id="myTable" class="whitespace-nowrap dataTable-table">
                                        <thead>
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" class="form-checkbox mt-1" :id="'chk' + {{ $category->id }}" :value="({{ $category->id }})" x-model.number="selectedRows">
                                                        </td>
                                                        {{-- <td>
                                                        ...
                                                        <td >{{$category->id}}</td>
                                                            ...
                                                            <td>
                                                                <div class="flex items-center font-semibold">
                                                                    ...
                                                                    <img class="h-8 w-8 rounded-full object-cover" src= "{{ asset($category->image) }}">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="flex gap-4 items-center">
                                                                ...
                                                                <a href="{{ route('edit.category', $category->id) }}" class="hover:text-info">
                                                                ...
                                                                <a href="{{ route('delete.category', $category->id) }}"  class="hover:text-danger" onclick="showAlert(event, '{{ $category->id }}') , @click="deleteRow(1)" >
