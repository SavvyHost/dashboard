                                        ...
                                        <div class="m-4">
                                            <div class="flex items-center justify-center w-full">
                                                <label
                                                    ...
                                                    <div id='side-svg-container'  class="pt-5 visible flex flex-col items-center justify-center ">
                                                    ...
                                                    <div id='side-img-container'  class="invisible flex  flex-col items-center justify-center  ">
                                                        <img id="side-img"  src="#" class="w-[100%]  pt-1 h-28" alt="your image" />
                                                    </div>
                                                        <input accept="image/*" class="opacity-0"  type='file' id="img-side-input" />
                                                </label>
                                            </div>
                                        </div>
